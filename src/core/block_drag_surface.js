...
Blockly.goog.provide('Blockly.BlockDragSurfaceSvg');
...
Blockly.BlockDragSurfaceSvg.prototype.translateSurface = function(x, y) {
  this.surfaceXY_ = new Blockly.goog.math.Coordinate(x * this.scale_, y * this.scale_);
 ...
 * @return {!Blockly.goog.math.Coordinate} Current translation of the surface.
 */
Blockly.BlockDragSurfaceSvg.prototype.getSurfaceTranslation = function() {
  var xy = Blockly.utils.getRelativeXY(this.SVG_);
  return new Blockly.goog.math.Coordinate(xy.x / this.scale_, xy.y / this.scale_);
};
