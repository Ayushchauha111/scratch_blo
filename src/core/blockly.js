...
Blockly.goog.provide('Blockly');

Blockly.goog.require('Blockly.BlockSvg.render');
Blockly.goog.require('Blockly.DropDownDiv');
Blockly.goog.require('Blockly.Events');
Blockly.goog.require('Blockly.FieldAngle');
Blockly.goog.require('Blockly.FieldCheckbox');
Blockly.goog.require('Blockly.FieldColour');
Blockly.goog.require('Blockly.FieldColourSlider');
// Date picker commented out since it increases footprint by 60%.
// Add it only if you need it.
//Blockly.goog.require('Blockly.FieldDate');
Blockly.goog.require('Blockly.FieldDropdown');
Blockly.goog.require('Blockly.FieldIconMenu');
Blockly.goog.require('Blockly.FieldImage');
Blockly.goog.require('Blockly.FieldNote');
Blockly.goog.require('Blockly.FieldTextInput');
Blockly.goog.require('Blockly.FieldTextInputRemovable');
Blockly.goog.require('Blockly.FieldTextDropdown');
Blockly.goog.require('Blockly.FieldNumber');
Blockly.goog.require('Blockly.FieldNumberDropdown');
Blockly.goog.require('Blockly.FieldMatrix');
Blockly.goog.require('Blockly.FieldVariable');
Blockly.goog.require('Blockly.FieldVerticalSeparator');
Blockly.goog.require('Blockly.Generator');
Blockly.goog.require('Blockly.Msg');
Blockly.goog.require('Blockly.Procedures');
Blockly.goog.require('Blockly.ScratchMsgs');
Blockly.goog.require('Blockly.Toolbox');
Blockly.goog.require('Blockly.Touch');
Blockly.goog.require('Blockly.WidgetDiv');
Blockly.goog.require('Blockly.WorkspaceSvg');
Blockly.goog.require('Blockly.constants');
Blockly.goog.require('Blockly.inject');
Blockly.goog.require('Blockly.utils');
Blockly.goog.require('goog.color');
